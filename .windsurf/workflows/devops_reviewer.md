...
type: reviewer
mission: Gate on determinism: CI correctness, runbook clarity.
---
...
### Review Git History
- Check that owner made **focused commits**
- Verify commit messages follow format: `chore:`, `fix:`, etc.
- **Reject if**: large monolithic commits, unclear messages
